...
class Action(str, Enum):
    """Canonical action names used throughout LETESE."""
    CREATE_CASE = "create_case"
    EDIT_CASE = "edit_case"
    DRAFT_DOCUMENT = "draft_documents"
    AI_DRAFT = "trigger_ai_draft"
    TRIGGER_SCRAPE = "trigger_scrape"
    SEND_MESSAGE = "send_client_message"
    UPLOAD_DOCUMENT = "upload_document"
    VIEW_CASE = "view_case"
    MANAGE_TEAM = "manage_team"
    VIEW_SYSTEM_HEALTH = "view_system_health"   # super_admin only
    CONFIGURE_VENDORS = "manage_vendors"          # super_admin only
...
_PLAN_FEATURES: dict[str, set[str]] = {
    "basic":       {"cases", "documents", "communications", "team_1"},
    "professional":{"cases", "documents", "communications", "team_5", "scraping"},
    "elite":       {"cases", "documents", "communications", "team_10", "scraping",
                    "ai_drafting", "translation", "whatsapp"},
    "enterprise":  {"cases", "documents", "communications", "team_unlimited",
                    "scraping", "ai_drafting", "translation", "whatsapp",
                    "post_judgment", "api_access", "sla"},
}


def check_plan_feature(plan: str, feature: str) -> bool:
    """
    Check whether `plan` includes the named `feature`.

    Args:
        plan:    One of: basic, professional, elite, enterprise
        feature: One of: cases, documents, communications, team_1,
                       team_5, team_10, team_unlimited, scraping,
                       ai_drafting, translation, whatsapp, post_judgment,
                       api_access, sla

    Returns:
        bool — True if the plan supports this feature.
    """
    return feature in _PLAN_FEATURES.get(plan, set())
